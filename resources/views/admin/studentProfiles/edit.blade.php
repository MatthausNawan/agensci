        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.studentProfile.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.student-profiles.update", [$studentProfile->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label for="name">{{ trans('cruds.studentProfile.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $studentProfile->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('couse_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="couse_name" id="couse_name" value="{{ old('couse_name', $studentProfile->couse_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('period') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="period" id="period" value="{{ old('period', $studentProfile->period) }}">
                        ...
                        <div class="form-group {{ $errors->has('university_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="university_name" id="university_name" value="{{ old('university_name', $studentProfile->university_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('lattes_link') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="lattes_link" id="lattes_link" value="{{ old('lattes_link', $studentProfile->lattes_link) }}">
                        ...
                        <div class="form-group {{ $errors->has('bio') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="bio" id="bio">{{ old('bio', $studentProfile->bio) }}</textarea>
                            @if($errors->has('bio'))
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $studentProfile->email) }}">
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $studentProfile->phone) }}">
                            @if($errors->has('phone'))
