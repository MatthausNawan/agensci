                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.adverts.update", [$advert->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('social_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="social_name" id="social_name" value="{{ old('social_name', $advert->social_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fantasy_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="fantasy_name" id="fantasy_name" value="{{ old('fantasy_name', $advert->fantasy_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('social_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="social_number" id="social_number" value="{{ old('social_number', $advert->social_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $advert->phone) }}">
                            @if($errors->has('phone'))
                        ...
                        <div class="form-group {{ $errors->has('mobile') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $advert->mobile) }}">
                        ...
                        <div class="form-group {{ $errors->has('zipcode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="zipcode" id="zipcode" value="{{ old('zipcode', $advert->zipcode) }}">
                        ...
                        <div class="form-group {{ $errors->has('state') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="state" id="state" value="{{ old('state', $advert->state) }}">
                            @if($errors->has('state'))
                        ...
                        <div class="form-group {{ $errors->has('contact_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_name" id="contact_name" value="{{ old('contact_name', $advert->contact_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_phone" id="contact_phone" value="{{ old('contact_phone', $advert->contact_phone) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_mobile') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_mobile" id="contact_mobile" value="{{ old('contact_mobile', $advert->contact_mobile) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="contact_email" id="contact_email" value="{{ old('contact_email', $advert->contact_email) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_social_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_social_number" id="contact_social_number" value="{{ old('contact_social_number', $advert->contact_social_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('reach_states') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="reach_states" id="reach_states">{{ old('reach_states', $advert->reach_states) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('reach_cities') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="reach_cities" id="reach_cities">{{ old('reach_cities', $advert->reach_cities) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('reach_categories') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="reach_categories" id="reach_categories">{{ old('reach_categories', $advert->reach_categories) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('reach_segments') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="reach_segments" id="reach_segments">{{ old('reach_segments', $advert->reach_segments) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('reach_genres') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="reach_genres" id="reach_genres">{{ old('reach_genres', $advert->reach_genres) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('advertising_place') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="advertising_place_id" id="advertising_place_id">
                                @foreach($advertising_places as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('advertising_place_id') ? old('advertising_place_id') : $advert->advertising_place->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('total_price') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_price" id="total_price" value="{{ old('total_price', $advert->total_price) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('reject_reason') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="reject_reason" id="reject_reason">{{ old('reject_reason', $advert->reject_reason) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('media_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="media_type" id="media_type">
                                ...
                                @foreach(App\Models\Advert::MEDIA_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('media_type', $advert->media_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('media_link') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="media_link" id="media_link" value="{{ old('media_link', $advert->media_link) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('media_file') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="media_file" id="media_file" value="{{ old('media_file', $advert->media_file) }}">
                        ...
                        <div class="form-group {{ $errors->has('start_at') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="start_at" id="start_at" value="{{ old('start_at', $advert->start_at) }}">
                        ...
                        <div class="form-group {{ $errors->has('end_at') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="end_at" id="end_at" value="{{ old('end_at', $advert->end_at) }}">
                        ...
                        <div class="form-group {{ $errors->has('enabled') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="enabled" id="enabled" value="1" {{ $advert->enabled || old('enabled', 0) === 1 ? 'checked' : '' }}>
