                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.promotions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="type" id="type">{{ old('type') }}</textarea>
                            @if($errors->has('type'))
                        ...
                        <div class="form-group {{ $errors->has('thematic') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="thematic" id="thematic">{{ old('thematic') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('resources_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="resources_amount" id="resources_amount" value="{{ old('resources_amount', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('subscription_period') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="subscription_period" id="subscription_period" value="{{ old('subscription_period', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('edital_link') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="edital_link" id="edital_link" value="{{ old('edital_link', '') }}">
