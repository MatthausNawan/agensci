                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('segment') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="segment_id" id="segment_id" required>
                                @foreach($segments as $id => $segment)
                                    <option value="{{ $id }}" {{ old('segment_id') == $id ? 'selected' : '' }}>{{ $segment }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('subscripition_period') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="subscripition_period" id="subscripition_period" value="{{ old('subscripition_period', '') }}">
