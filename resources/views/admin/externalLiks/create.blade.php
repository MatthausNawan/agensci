        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.externalLik.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.external-liks.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('site') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="site" id="site" value="{{ old('site', '') }}">
                            @if($errors->has('site'))
