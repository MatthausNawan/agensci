        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.publishCall.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.publish-calls.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('magazine') ? 'has-error' : '' }}">
                            <label for="magazine">{{ trans('cruds.publishCall.fields.magazine') }}</label>
                            <input class="form-control" type="text" name="magazine" id="magazine" value="{{ old('magazine', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('issn') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="issn" id="issn" value="{{ old('issn', '') }}">
                            @if($errors->has('issn'))
                        ...
                        <div class="form-group {{ $errors->has('qualis') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="qualis" id="qualis" value="{{ old('qualis', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('dossie') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="dossie" id="dossie">{{ old('dossie') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('theme') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="theme" id="theme">{{ old('theme') }}</textarea>
                            @if($errors->has('theme'))
                        ...
                        <div class="form-group {{ $errors->has('organizatin') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="organizatin" id="organizatin" value="{{ old('organizatin', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('submission_period') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="submission_period" id="submission_period" value="{{ old('submission_period', '') }}">
