                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contests.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('occupations') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="occupations" id="occupations">{{ old('occupations') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('vacancies') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="vacancies" id="vacancies" value="{{ old('vacancies', '') }}" step="1">
