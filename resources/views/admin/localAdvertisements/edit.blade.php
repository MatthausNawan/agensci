        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.localAdvertisement.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.local-advertisements.update", [$localAdvertisement->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label class="required" for="name">{{ trans('cruds.localAdvertisement.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $localAdvertisement->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('page') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="page" id="page" required>
                                ...
                                @foreach(App\Models\LocalAdvertisement::PAGE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('page', $localAdvertisement->page) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('page'))
                        ...
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $localAdvertisement->location) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('country_percent') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="country_percent" id="country_percent" value="{{ old('country_percent', $localAdvertisement->country_percent) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('genre_percent') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="genre_percent" id="genre_percent" value="{{ old('genre_percent', $localAdvertisement->genre_percent) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('category_percent') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="category_percent" id="category_percent" value="{{ old('category_percent', $localAdvertisement->category_percent) }}" step="0.00001">
                        ...
                        <div class="form-group {{ $errors->has('area_percent') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="area_percent" id="area_percent" value="{{ old('area_percent', $localAdvertisement->area_percent) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('days_percent') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="days_percent" id="days_percent" value="{{ old('days_percent', $localAdvertisement->days_percent) }}" step="0.01" required>
