                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.jobs.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('formation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="formation" id="formation" value="{{ old('formation', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('ocuppation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ocuppation" id="ocuppation" value="{{ old('ocuppation', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('qty_jobs') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="qty_jobs" id="qty_jobs" value="{{ old('qty_jobs', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('expiration_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="expiration_date" id="expiration_date" value="{{ old('expiration_date') }}">
