<div class="links-wrapper p-2">
    ...
    @if($teacher)
        <div class="data d-flex flex-column">
            ...
            <div class="border-bottom d-flex flex-column my-2 pb-2">
            ...
            <div class="">
                <a href="{{route('teachers.profile')}}" class="btn border rounded text-black btn-sm pull-right">Meu Cadastro</a>
            </div>
        </div>
    @endif    
</div>
