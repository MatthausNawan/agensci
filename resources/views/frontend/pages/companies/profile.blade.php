                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-8 col-sm-6">
                            ...
                            <input type="text" name="fantasy_name" class="form-control {{ $errors->has('fantasy_name') ? 'is-invalid' : '' }} " value="{{ $profile->fantasy_name ?? old('fantasy_name', '') }}">
                        ...
                        <div class="form-group col-4 col-sm-6">
                            ...
                            <input type="text"  name="cnpj" class="cnpj form-control {{ $errors->has('cnpj') ? 'is-invalid' : '' }}" value="{{ $profile->cnpj ?? old('cnpj', '') }}" placeholder="00.000.000/0000-00">
                            @if($errors->has('cnpj'))
                            <div class="invalid-feedback">
                                {{ $errors->first('cnpj') }}
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-10">
                            ...
                            <input type="text" id="cidade" class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city" value="{{ $profile->city ?? old('city', '') }}">
                            @if($errors->has('city'))
                            <div class="invalid-feedback">
                                {{ $errors->first('city') }}
                            </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" id="uf" class="form-control {{ $errors->has('uf') ? 'is-invalid' : '' }}" name="uf" value="{{ $profile->uf ?? old('uf', '') }}">
                            @if($errors->has('uf'))
                            <div class="invalid-feedback">
                                {{ $errors->first('uf') }}
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input type="text" class="phone form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" name="phone" value="{{ $profile->phone ?? old('phone', '') }}" placeholder="(DD) 9999-9999">
                            @if($errors->has('phone'))
                            <div class="invalid-feedback">
                                {{ $errors->first('phone') }}
                            </div>
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input type="text" class="mobile form-control {{ $errors->has('cell_number') ? 'is-invalid' : '' }}" name="cell_number" value="{{ $profile->cell_number ?? old('cell_number', '') }}" placeholder="(DD) 99999-9999">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="site" class="form-control {{ $errors->has('site') ? 'is-invalid' : '' }}" value="{{ $profile->site ?? old('site', '') }}">
                        @if($errors->has('site'))
                        <div class="invalid-feedback">
                            {{ $errors->first('site') }}
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" name="linkedin" placeholder="Link do Likedin" value="{{ $profile->linkedin ?? old('linkedin', '') }}">
                            <input type="text" class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" name="facebook" placeholder="Link do Facebook" value="{{ $profile->facebook ?? old('facebook', '') }}">
                            <input type="text" class="form-control {{ $errors->has('whatsapp') ? 'is-invalid' : '' }}" name="whatsapp" placeholder="Link do WhatsApp" value="{{ $profile->whatsapp ?? old('whatsapp', '') }}">
                            <input type="text" class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" name="instagram" placeholder="Link do Instagram" value="{{ $profile->instagram ?? old('instagram', '') }}">
                            <input type="text" class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" name="twitter" placeholder="Link do Twitter" value="{{ $profile->twitter ?? old('twitter', '') }}">
                            <input type="text" class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" name="youtube" placeholder="Link do YouTube" value="{{ $profile->youtube ?? old('youtube', '') }}">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="Site" class="required">Responsável pela solicitação:</label>
                        <input type="text" name="requester_name" class="form-control {{ $errors->has('requester_name') ? 'is-invalid' : '' }} " value="{{ $profile->youtube ?? old('requester_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="cpf form-control {{ $errors->has('requester_cpf') ? 'is-invalid' : '' }}" name="requester_cpf" value="{{$profile->requester_cpf ??  old('requester_cpf', '') }}" placeholder="123.456.123-99">
