...
<div class="row my-4">
    <div class="col-lg-6 offset-3">
        <div class="card">
            ...
            <form action="{{route('companies.personal-links.update',$personalLink->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
            ...
            <form action="{{route('companies.personal-links.destroy',$personalLink->id) }}" method="post">
                @csrf
                @method('DELETE')
