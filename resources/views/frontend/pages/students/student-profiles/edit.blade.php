            ...
            <form action="{{route('students.student-profiles.update',$studentProfile->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="speeches" id="" cols="30" rows="10" class="form-control" placeholder="Para separar utilize ponto e virgula ; ">{{$studentProfile->speeches ?? old('speeches')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="monitorings" id="" cols="30" rows="10" class="form-control" placeholder="Para separar utilize ponto e virgula ; ">{{ $studentProfile->monitorings ?? old('monitorings')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="awards" id="" cols="30" rows="10" class="form-control" placeholder="Para separar utilize ponto e virgula ; ">{{$studentProfile->awards ?? old('awards')}}</textarea>
