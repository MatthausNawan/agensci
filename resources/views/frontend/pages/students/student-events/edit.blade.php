...
<div class="row">
    <div class="col-lg-6">
        <div class="card">            
            <form action="{{ route('students.student-events.update',$studentEvent->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="title" value="{{ old('title',$studentEvent->title) }}">
                        @if($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="location" value="{{ old('location',$studentEvent->location) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="link" placeholder="link do evento" value="{{ old('link',$studentEvent->link) }}">
                        @if($errors->has('link'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="period" placeholder="De 00/00/00 á 00/00/00" value="{{ old('period',$studentEvent->period) }}">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-sm btn-outline-danger">Atualizar</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    init: function () {
@if(isset($studentEvent) && $studentEvent->banner)
      var file = {!! json_encode($studentEvent->banner) !!}
